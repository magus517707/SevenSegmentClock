...
PCA9685_STATUS PCA9685_SubaddressRespond(I2C_HandleTypeDef *pca9685_i2c, SubaddressBit Subaddress, uint8_t Enable)
{
	return PCA9685_SetBit(pca9685_i2c, PCA9685_MODE1, Subaddress, Enable);
}

PCA9685_STATUS PCA9685_AllCallRespond(I2C_HandleTypeDef *pca9685_i2c, uint8_t Enable)
{
	return PCA9685_SetBit(pca9685_i2c, PCA9685_MODE1, PCA9685_MODE1_ALCALL_BIT, Enable);
}
